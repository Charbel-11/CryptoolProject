...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->CETButton->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->CETButton->Name = L"CETButton";
			this->CETButton->Size = System::Drawing::Size(322, 45);
			...
			this->AESButton->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->AESButton->Name = L"AESButton";
			this->AESButton->Size = System::Drawing::Size(322, 45);
			...
			this->PAButton->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->PAButton->Name = L"PAButton";
			this->PAButton->Size = System::Drawing::Size(322, 45);
			...
			this->DESButton->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->DESButton->Name = L"DESButton";
			this->DESButton->Size = System::Drawing::Size(322, 45);
			...
			// NTButton
			// 
			this->NTButton->Location = System::Drawing::Point(226, 309);
			this->NTButton->Margin = System::Windows::Forms::Padding(3, 5, 3, 5);
			this->NTButton->Name = L"NTButton";
			this->NTButton->Size = System::Drawing::Size(322, 45);
			this->NTButton->TabIndex = 5;
			this->NTButton->Text = L"Number Theory";
			this->NTButton->UseVisualStyleBackColor = true;
			this->NTButton->Click += gcnew System::EventHandler(this, &MainForm::NTButton_Click);
			// 
			// MainForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(9, 20);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(770, 465);
